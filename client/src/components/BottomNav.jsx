...
const BottomNav = () =>{
    return(
        <div id='BNav' className="mx-6">
       <Link> <svg id='active' xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" className="bi bi-house" viewBox="0 0 16 16">
